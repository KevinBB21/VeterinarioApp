...
class Aplicacion : Application() {
    ...
    private fun agregarReviews() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            baseDeDatos.reviewDao().borrarTodasLasReviews()
            baseDeDatos.reviewDao().actualizarReviews()
                ...
                listOf(
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/incendios-california-arma-politica-trump-adversarios-politicos/16406076.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/guerra-gaza-israel-hamas-tregua-negociaciones/16405926.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/feijoo-pp-reforma-pensiones-gobierno/16406190.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/deportes/20250114/kike-salas-detenido-forzar-tarjetas-amarillas-apuestas-ilegales/16406570.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/gobierno-supremo-acusa-fiscal-general-sin-pruebas-concretas-vincula-moncloa-basandose-elucubraciones/16406646.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/gobierno-nombra-a-alvaro-fernandez-heredia-como-nuevo-presidente-renfe/16406115.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250112/buscar-piso-madrid-como-intentaron-estafar/16381102.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/bot-social-hogar-inteligente-tecnologia-cuida-acompana-personas-mayores/16282330.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250114/nasa-lanza-mision-blue-ghost-luna-base-humana-permanente/16406173.shtml"
                    ),
                    ReviewEntity(
                        ...
                        reviewUrl = "https://www.rtve.es/reviews/20250113/eventos-astronomicos-no-puedes-perder-2025-eclipse-sol-dos-luna/16400387.shtml"
                    )
                ).forEach { review ->
                    baseDeDatos
                        .reviewDao()
